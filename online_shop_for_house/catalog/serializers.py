...
from catalog.models import Category, Product, ProductImage, Discount, Seller, OrderProducts, Order, Promocode, Cashback
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = (
            'created_at', 'delivery_address', 'delivery_method', 'payment_method', 'payment_status',
            'status', 'total_sum', 'delivery_notification_before', 'products', 'promocode', 'use_cashback'
        )
